...
public void InsertTail(int value)
{
    ...
    // Otherwise, attach it to the current tail and update the tail
    else
    {
        _tail.Next = newNode;
        newNode.Prev = _tail;
...
{
    // empty list or single-node list -> clear both
    if (_head == _tail)
    {
        _head = null;
        _tail = null;
    }
    // multi-node list -> detach last node
    else if (_tail is not null)
    {
        _tail.Prev!.Next = null; // disconnect last from its previous
    ...
    public IEnumerable Reverse()
{
    ...
    while (curr is not null)
    {
        ...
        curr = curr.Prev;       // move left (backward)
    }
}
